...
const body=document.body,menu=document.querySelector(".header__menu");function toggleElement(e,t){t.classList.contains("active")?(t.classList.remove("active"),e.classList.remove("lock")):(t.classList.add("active"),e.classList.add("lock"))}function burgerHandler(){requestAnimationFrame(()=>toggleElement(body,menu))}const popup=document.querySelector(".popup"),requestButtons=document.querySelectorAll(".request__btn"),closePopup=document.querySelector(".popup__close");function popupHandler(){requestAnimationFrame(()=>toggleElement(body,popup))}function hidePopup(){popup.classList.remove("active"),body.classList.remove("lock")}function toggleHeader(e){let n=window.scrollY||document.documentElement.scrollTop,o,r=0,s=0;const i=document.querySelector(".header");window.addEventListener("scroll",function(){if(o=window.scrollY||document.documentElement.scrollTop,o>n?r=2:o<n&&(r=1),r!==s){var e=r,t=o;if(e===2&&t>100){i.classList.add("hide");s=e}else if(e===1){i.classList.remove("hide");s=e}}n=o})}function addFixedClassToHeader(){const e=document.querySelector(".header");let t=e.offsetHeight+300;window.addEventListener("scroll",function(){this.scrollY>t?e.classList.add("fixed"):e.classList.remove("fixed")})}const form=document.querySelector(".popup__form"),inputs=Array.from(document.querySelectorAll(".popup__input"));function addErrorMsg(e,t){e.parentElement.nextElementSibling.classList.add("error");const n=e.parentElement.previousElementSibling;n.textContent=t,n.classList.add("active")}function showError(e){"name"===e.name?e.validity.valueMissing?addErrorMsg(e,"Fill in the 'name' fild."):e.validity.tooShort&&addErrorMsg(e,"Name should be at least 3 characters."):"phone"===e.name&&e.value.includes("_")&&addErrorMsg(e,"Type correct phone number.")}document.addEventListener("DOMContentLoaded",function(e){const t=document.querySelector(".header__burger"),n=(window.innerWidth<=1599&&t.addEventListener("click",burgerHandler),window.matchMedia("(max-width: 1599px)"));function o(e){const t=e.parentElement.previousElementSibling;t.textContent="",t.className="popup__error",e.parentElement.nextElementSibling.classList.remove("error")}n.addEventListener("change",function(e){e.matches?t.addEventListener("click",burgerHandler):(t.removeEventListener("click",burgerHandler),menu.classList.remove("active"),body.classList.remove("lock"))}),requestButtons.forEach(e=>e.addEventListener("click",popupHandler)),closePopup.addEventListener("click",hidePopup),toggleHeader(),addFixedClassToHeader(),inputs.forEach(e=>e.addEventListener("input",()=>{("name"===e.name&&e.validity.valid||"phone"===e.name&&e.value.includes("_")?o:showError)(e)})),form.addEventListener("submit",function(t){inputs.forEach(e=>{"name"===e.name?e.validity.valid||(t.preventDefault(),showError(e)):"phone"===e.name&&e.value.includes("_")&&(t.preventDefault(),showError(e))})});var r=document.getElementById("phoneInput");new IMask(r,{mask:"+{7}(000)000-00-00",lazy:!1})});